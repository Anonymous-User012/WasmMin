...
struct Unsubtyping
  ...
  void visitEncoding(Encoding* encoding) {
    // Add your logic here for handling Encoding nodes
    // For example, you might want to note subtypes or casts related to Encoding
  }
