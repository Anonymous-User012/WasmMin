...
// custom encoding
BinaryenExpressionRef BinaryenEncoding(BinaryenModuleRef module,
                                    BinaryenOp op) {
  return static_cast<Expression*>(
    Builder(*(Module*)module).makeEncoding(EncodingOp(op)));
}
// end custom encoding
...
BinaryenIndex BinaryenCallIndirectGetNumOperands(BinaryenExpressionRef expr) {
  ...
  // std::cout << "BinaryenCallIndirectGetNumOperands" << std::endl;
  // std::cout << "Expression: " << std::endl;
  // expression->dump();
  // std::cout << "Num of Operands: ";
  // std::cout << static_cast<CallIndirect*>(expression)->operands.size() << std::endl;
