...
void BinaryInstWriter::visitLocalGet(LocalGet* curr) {
  ...
  // std::cout << "Encoding local.get: index = " << curr->index << std::endl;
  // for (const auto& pair : mappedLocals) {
  //     std::cout << "mappedLocals[" << pair.first.first << ", " << pair.first.second 
  ...
  // std::cout << "Local index: " << curr->index << ", numValues: " << numValues << std::endl;
  ...
  //               << "] = " << pair.second << std::endl;
  // }
  // std::cout << "---------------- local get call " << std::endl;
}
...
void BinaryInstWriter::visitEncoding(Encoding* curr) {
  switch (curr->op) {
    case newOP0:
      o << int8_t(BinaryConsts::newOP0);
      break;
    case newOP1:
      o << int8_t(BinaryConsts::newOP1);
      break;
    case newOP2:
      o << int8_t(BinaryConsts::newOP2);
      break;
    case newOP3:
      o << int8_t(BinaryConsts::newOP3);
      break;
    case newOP4:
      o << int8_t(BinaryConsts::newOP4);
      break;
    case newOP5:
      o << int8_t(BinaryConsts::newOP5);
      break;
    case newOP6:
      o << int8_t(BinaryConsts::newOP6);
      break;
    case newOP7:
      o << int8_t(BinaryConsts::newOP7);
      break;
    case newOP8:
      o << int8_t(BinaryConsts::newOP8);
      break;
    case newOP9:
      o << int8_t(BinaryConsts::newOP9);
      break;
    case newOP10:
      o << int8_t(BinaryConsts::newOP10);
      break;
    case newOP11:
      o << int8_t(BinaryConsts::newOP11);
      break;
    case newOP12:
      o << int8_t(BinaryConsts::newOP12);
      break;
    case newOP13:
      o << int8_t(BinaryConsts::newOP13);
      break;
    case newOP14:
      o << int8_t(BinaryConsts::newOP14);
      break;
    case newOP15:
      o << int8_t(BinaryConsts::newOP15);
      break;
    case newOP16:
      o << int8_t(BinaryConsts::newOP16);
      break;
    case newOP17:
      o << int8_t(BinaryConsts::newOP17);
      break;
    case newOP18:
      o << int8_t(BinaryConsts::newOP18);
      break;
    case newOP19:
      o << int8_t(BinaryConsts::newOP19);
      break;
    case newOP20:
      o << int8_t(BinaryConsts::newOP20);
      break;
    case newOP21:
      o << int8_t(BinaryConsts::newOP21);
      break;
    case newOP22:
      o << int8_t(BinaryConsts::newOP22);
      break;
    case newOP23:
      o << int8_t(BinaryConsts::newOP23);
      break;
    case newOP24:
      o << int8_t(BinaryConsts::newOP24);
      break;
    case newOP25:
      o << int8_t(BinaryConsts::newOP25);
      break;
    case newOP26:
      o << int8_t(BinaryConsts::newOP26);
      break;
    case newOP27:
      o << int8_t(BinaryConsts::newOP27);
      break;
    case newOP28:
      o << int8_t(BinaryConsts::newOP28);
      break;
    case newOP29:
      o << int8_t(BinaryConsts::newOP29);
      break;
    case newOP30:
      o << int8_t(BinaryConsts::newOP30);
      break;
    case newOP31:
      o << int8_t(BinaryConsts::newOP31);
      break;
    case newOP32:
      o << int8_t(BinaryConsts::newOP32);
      break;
    case newOP33:
      o << int8_t(BinaryConsts::newOP33);
      break;
    case newOP34:
      o << int8_t(BinaryConsts::newOP34);
      break;
    case newOP35:
      o << int8_t(BinaryConsts::newOP35);
      break;
    case newOP36:
      o << int8_t(BinaryConsts::newOP36);
      break;
    case newOP37:
      o << int8_t(BinaryConsts::newOP37);
      break;
    case newOP38:
      o << int8_t(BinaryConsts::newOP38);
      break;
    case newOP39:
      o << int8_t(BinaryConsts::newOP39);
      break;
    case newOP40:
      o << int8_t(BinaryConsts::newOP40);
      break;
    case newOP41:
      o << int8_t(BinaryConsts::newOP41);
      break;
    case newOP42: 
      o << int8_t(BinaryConsts::newOP42);
      break;
    case newOP43:
      o << int8_t(BinaryConsts::newOP43);
      break;
    case newOP44: 
      o << int8_t(BinaryConsts::newOP44);
      break;
    case newOP45:
      o << int8_t(BinaryConsts::newOP45);
      break;
    case newOP46:
      o << int8_t(BinaryConsts::newOP46);
      break;
    case newOP47:
      o << int8_t(BinaryConsts::newOP47);
      break;
    case newOP48:
      o << int8_t(BinaryConsts::newOP48);
      break;
    case newOP49:
      o << int8_t(BinaryConsts::newOP49);
      break;
    case newOP50:
      o << int8_t(BinaryConsts::newOP50);
      break;
    case newOP51:
      o << int8_t(BinaryConsts::newOP51);
      break;
    case newOP52:
      o << int8_t(BinaryConsts::newOP52);
      break;
    case newOP53:
      o << int8_t(BinaryConsts::newOP53);
      break;
    case newOP54:
      o << int8_t(BinaryConsts::newOP54);
      break;
    case newOP55:
      o << int8_t(BinaryConsts::newOP55);
      break;
    case newOP56:
      o << int8_t(BinaryConsts::newOP56);
      break;
    case newOP57:
      o << int8_t(BinaryConsts::newOP57);
      break;
    case newOP58:
      o << int8_t(BinaryConsts::newOP58);
      break;
    case newOP59:
      o << int8_t(BinaryConsts::newOP59);
      break;
    case newOP60:
      o << int8_t(BinaryConsts::newOP60);
      break;
    case newOP61:
      o << int8_t(BinaryConsts::newOP61);
      break;
    case newOP62:
      o << int8_t(BinaryConsts::newOP62);
      break;
    case newOP63:
      o << int8_t(BinaryConsts::newOP63);
      break;
    case newOP64:
      o << int8_t(BinaryConsts::newOP64);
      break;
    case newOP65:
      o << int8_t(BinaryConsts::newOP65);
      break;
    case newOP66:
      o << int8_t(BinaryConsts::newOP66);
      break;
    case newOP67:
      o << int8_t(BinaryConsts::newOP67);
      break;
    case newOP68:
      o << int8_t(BinaryConsts::newOP68);
      break;
    case InvalidEncoding:
      WASM_UNREACHABLE("InvalidEncoding op");
    default:
      WASM_UNREACHABLE("Unknown Encoding op");
  }
}
...
void BinaryInstWriter::visitBinary(Binary* curr) {
  switch (curr->op) {
    ...
    // custom opcodes 
    // case CustomOpcode0:
    //   o << int8_t(BinaryConsts::CustomOpcode0);
    //   break;
...
void BinaryInstWriter::mapLocalsAndEmitHeader() {
  ...
  // add a flag to control: force trivial mapping
  bool forceTrivialMapping = true; 

  if (DWARF || forceTrivialMapping) {
